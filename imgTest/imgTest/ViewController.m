...
//    [self testVideo];
    ...
    UIButton *btn2 = [[UIButton alloc] initWithFrame:CGRectMake(100, 500, 100, 40)];
    ...
    UIButton *btn21 = [[UIButton alloc] initWithFrame:CGRectMake(200, 500, 100, 40)];
    [btn21 setTitle:@"美化" forState:UIControlStateNormal];
    [btn21 setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    [btn21 addTarget:self action:@selector(beautify) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:btn21];
    
    UIButton *btn3 = [[UIButton alloc] initWithFrame:CGRectMake(0, 550, 100, 40)];
    ...
    UIButton *btn4 = [[UIButton alloc] initWithFrame:CGRectMake(110, 550, 100, 40)];
    ...
    UIButton *btn41 = [[UIButton alloc] initWithFrame:CGRectMake(220, 550, 100, 40)];
    [btn41 setTitle:@"test1" forState:UIControlStateNormal];
    [btn41 setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    [btn41 addTarget:self action:@selector(test1) forControlEvents:UIControlEventTouchUpInside];
...
-(void)baseUse{
    ...
    //[disFilter setContrast:2.0f];
    //饱和度
    //GPUImageSaturationFilter *disFilter = [[GPUImageContrastFilter alloc] init];
    //[disFilter setSaturation:2.0f];
    //结构
    //阴影
    //GPUImageOverlayBlendFilter *disFilter = [[GPUImageOverlayBlendFilter alloc] init];
    //高亮阴影
    //GPUImageHighlightShadowFilter *disFilter = [[GPUImageHighlightShadowFilter alloc] init];
    //disFilter.shadows = 0;
    //disFilter.highlights = 1;
    //交叉线阴影
    //GPUImageCrosshatchFilter *disFilter = [[GPUImageCrosshatchFilter alloc] init];
...
- (void)test1{
    ...
    CustomFilterTest1 *disFilter = [[CustomFilterTest1 alloc] init];
